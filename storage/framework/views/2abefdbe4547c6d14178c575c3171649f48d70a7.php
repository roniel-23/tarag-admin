...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title inertia><?php echo e(config('app.name', 'TARA G!')); ?></title>

        <link rel="icon" href="<?php echo e(URL::asset('tarag_logo.png')); ?>" type="image/x-icon"/>
        <!-- Fonts -->
...
<?php /**PATH C:\Users\HP\Documents\Roniel D\Laravel-vue\tara-g-admin\resources\views/app.blade.php ENDPATH**/ ?>